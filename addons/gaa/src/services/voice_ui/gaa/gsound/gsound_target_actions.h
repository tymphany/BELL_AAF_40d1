...
typedef enum {
   ...
   *
   */
  GSOUND_TARGET_ACTION_GA_VOICE_DONE = (1 << 4),
   ...
   */
  GSOUND_TARGET_ACTION_GA_STOP_ASSISTANT = (1 << 5),
   ...
   */
  GSOUND_TARGET_ACTION_GA_VOICE_CONFIRM = (1 << 6),
   ...
   */
  GSOUND_TARGET_ACTION_GA_FETCH_PREPARE = (1 << 7),
   ...
   *     -------------------------------------------------------------------
   */
  GSOUND_TARGET_ACTION_GA_FETCH = (1 << 8),
