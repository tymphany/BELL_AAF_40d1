...
#include "timing_trace/timing_trace_types_for_ops.h"
...
/**
 * \brief Record an operator specific event for an operator terminal
 * \param opep_id An operator terminal ID
 * \param event_type Operator event type
 * \param arg1 Event-specific data
 * \param arg2 Event-specific data
 */
extern void opmgr_record_timing_trace_op_term_event(
        ENDPOINT_ID opep_id,
...
/**
 * \brief Record an operator specific event for an operator
 * \param op_id An external operator ID
 * \param event_type Operator event type
 * \param arg1 Event-specific data
 * \param arg2 Event-specific data
 */
static inline void opmgr_record_timing_trace_op_event(
        OPERATOR_ID op_id,
        TIMING_TRACE_OP_EVENT_TYPE event_type,
        unsigned arg1,
        unsigned arg2)
{
    opmgr_record_timing_trace_op_term_event(op_id, event_type, arg1, arg2);
}
