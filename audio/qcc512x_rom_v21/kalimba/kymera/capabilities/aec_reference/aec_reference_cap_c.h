 ...
 * However, in 2.1 tests (and not 2.0 or auraplus, we see (quite persistently)
 * this can slightly go above 0.1 ppm (0.13 ppm have been observed) so we want
 * to increase the max to 0.2 ppm.
 */
#define AEC_REFERENCE_REF_MIC_ADJ_MAX  FRACTIONAL(2e-7)
