 ...
 VALUES
    ...
    OPMSG_COMMON_SET_RATE_ADJUST_PASSTHROUGH_MODE
                   - Message to set/clear the passthrough mode of a standalone
                     ...
                     used by the framework only, and shall not be used directly
                     by user.
    OPMSG_COMMON_REINIT_ALGORITHM
                   - Reinitialize all algorithm specific data in an operator to
...
typedef enum
{
    ...
    OPMSG_COMMON_REINIT_ALGORITHM = 0x201D
} OPMSG_COMMON_ID;
/*******************************************************************************
...
/*******************************************************************************
 ...
 VALUES
    SET_STREAM_TRANSFORMS   - The operator message tells the operator which
                              ...
                              operator.
    SET_STREAM_TIMING_TRACE - The operator message tells the operator to extract
                              timing trace data on a channel.

*******************************************************************************/
typedef enum
{
    OPMSG_KSP_ID_SET_STREAM_TRANSFORMS = 0x0001,
    OPMSG_KSP_ID_SET_STREAM_TIMING_TRACE = 0x0003
} OPMSG_KSP_ID;
/*******************************************************************************
...
/*******************************************************************************
  ...
  DESCRIPTION
    TTP mode can be one of the following:

 VALUES
    FULL_TTP      - Full TTP mode.
    FREE_RUN      - Free run mode
    FULL_TTP_ONLY - Full TTP mode without any parameter update.
    FREE_RUN_ONLY - Free run mode  without any parameter update

*******************************************************************************/
typedef enum
{
    OPMSG_TTP_MODE_FULL_TTP = 0x0000,
    OPMSG_TTP_MODE_FREE_RUN = 0x0001,
    OPMSG_TTP_MODE_FULL_TTP_ONLY = 0x0002,
    OPMSG_TTP_MODE_FREE_RUN_ONLY = 0x0003
} OPMSG_TTP_MODE;
/*******************************************************************************
...
/*******************************************************************************
  ...
  DESCRIPTION
    Messages for Volume Control operator

 VALUES
    SET_AUX_TIME_TO_PLAY       - Sets the time that an auxiliary input shall be
                                 played at.
    SET_DOWNSTREAM_LATENCY_EST - Sets an estimate of max latency in downstream
                                 after this operator.

*******************************************************************************/
typedef enum
{
    OPMSG_VOL_CTRL_ID_SET_AUX_TIME_TO_PLAY = 0x0001,
    OPMSG_VOL_CTRL_ID_SET_DOWNSTREAM_LATENCY_EST = 0x0002
} OPMSG_VOL_CTRL_ID;
/*******************************************************************************
...
/*******************************************************************************
  ...
  DESCRIPTION
    WWE configuration messages

 VALUES
    RESET_STATUS                   - Resets WWE status
    MODE_CHANGE                    - Sets the operating MODE for the WWE
    TRIGGER_PHRASE_LOAD            - Requests WWE to use the listed trigger
                                     phrase files
    TRIGGER_PHRASE_UNLOAD          - Requests WWE to unload the listed trigger
                                     phrase files
    STRIP_TRIGGER_PHRASE_FLAG      - Requests WWE to pass through audio data
                                     only after detecting the end of trigger
                                     phrase
    SET_MIN_MAX_TRIGGER_PHRASE_LEN - When detecting the start and the end of the
                                     trigger phrase timestamp the length can be
...
typedef enum
{
    OPMSG_WWE_ID_RESET_STATUS = 0x0000,
    OPMSG_WWE_ID_MODE_CHANGE = 0x0001,
    OPMSG_WWE_ID_TRIGGER_PHRASE_LOAD = 0x0002,
    OPMSG_WWE_ID_TRIGGER_PHRASE_UNLOAD = 0x0003,
    OPMSG_WWE_ID_STRIP_TRIGGER_PHRASE_FLAG = 0x0004,
    OPMSG_WWE_ID_SET_MIN_MAX_TRIGGER_PHRASE_LEN = 0x0005
} OPMSG_WWE_ID;
/*******************************************************************************
  ...
  DESCRIPTION
    WWE mode type: mode can be one of the following:

 VALUES
    FULL_PROC     - WWE tries to detect key phrase
    PASS_THRU     - WWE simply passes data through
    PURGE_DATA    - Consumes all data at input with no processing
    FORCE_TRIGGER - For test purposes only, it forces WWE to behave as if speech
                    is detected

*******************************************************************************/
typedef enum
{
    OPMSG_WWE_MODE_FULL_PROC = 0x0001,
    OPMSG_WWE_MODE_PASS_THRU = 0x0002,
    OPMSG_WWE_MODE_PURGE_DATA = 0x0003,
    OPMSG_WWE_MODE_FORCE_TRIGGER = 0x00FF
} OPMSG_WWE_MODE;
/*******************************************************************************
...
/*******************************************************************************
  ...
  NAME
    OPMSG_WWE_MODE_CHANGE

  DESCRIPTION
    Sets the operating MODE for the WWE

  MEMBERS
    message_id   - message id
    working_mode - The mode is of the type OPMSG_WWE_MODE
...
/* The following macros take OPMSG_WWE_MODE_CHANGE *opmsg_wwe_mode_change_ptr */
#define OPMSG_WWE_MODE_CHANGE_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_MODE_CHANGE_MESSAGE_ID_GET(opmsg_wwe_mode_change_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_mode_change_ptr)->_data[0])
#define OPMSG_WWE_MODE_CHANGE_MESSAGE_ID_SET(opmsg_wwe_mode_change_ptr, message_id) ((opmsg_wwe_mode_change_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_MODE_CHANGE_WORKING_MODE_WORD_OFFSET (1)
#define OPMSG_WWE_MODE_CHANGE_WORKING_MODE_GET(opmsg_wwe_mode_change_ptr) ((OPMSG_WWE_MODE)(opmsg_wwe_mode_change_ptr)->_data[1])
#define OPMSG_WWE_MODE_CHANGE_WORKING_MODE_SET(opmsg_wwe_mode_change_ptr, working_mode) ((opmsg_wwe_mode_change_ptr)->_data[1] = (uint16)(working_mode))
#define OPMSG_WWE_MODE_CHANGE_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_MODE_CHANGE_CREATE(message_id, working_mode) \
    (uint16)(message_id), \
    (uint16)(working_mode)
#define OPMSG_WWE_MODE_CHANGE_PACK(opmsg_wwe_mode_change_ptr, message_id, working_mode) \
    do { \
        (opmsg_wwe_mode_change_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_mode_change_ptr)->_data[1] = (uint16)((uint16)(working_mode)); \
    } while (0)

#define OPMSG_WWE_MODE_CHANGE_MARSHALL(addr, opmsg_wwe_mode_change_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_mode_change_ptr), 2)
#define OPMSG_WWE_MODE_CHANGE_UNMARSHALL(addr, opmsg_wwe_mode_change_ptr) memcpy((void *)(opmsg_wwe_mode_change_ptr), (void *)(addr), 2)
...
/*******************************************************************************
  ...
  NAME
    Opmsg_Common_Msg_Reinit_Algorithm

  DESCRIPTION
    Operator common message for OPMSG_COMMON_REINIT_ALGORITHM
...
/* The following macros take OPMSG_COMMON_MSG_REINIT_ALGORITHM *opmsg_common_msg_reinit_algorithm_ptr */
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_MESSAGE_ID_GET(opmsg_common_msg_reinit_algorithm_ptr) ((OPMSG_COMMON_ID)(opmsg_common_msg_reinit_algorithm_ptr)->_data[0])
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_MESSAGE_ID_SET(opmsg_common_msg_reinit_algorithm_ptr, message_id) ((opmsg_common_msg_reinit_algorithm_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_CREATE(message_id) \
    (uint16)(message_id)
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_PACK(opmsg_common_msg_reinit_algorithm_ptr, message_id) \
    do { \
        (opmsg_common_msg_reinit_algorithm_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
    } while (0)

#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_MARSHALL(addr, opmsg_common_msg_reinit_algorithm_ptr) memcpy((void *)(addr), (void *)(opmsg_common_msg_reinit_algorithm_ptr), 1)
#define OPMSG_COMMON_MSG_REINIT_ALGORITHM_UNMARSHALL(addr, opmsg_common_msg_reinit_algorithm_ptr) memcpy((void *)(opmsg_common_msg_reinit_algorithm_ptr), (void *)(addr), 1)
...
/*******************************************************************************
  ...
  NAME
    OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN
...
/* The following macros take OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN *opmsg_wwe_set_min_max_trigger_phrase_len_ptr */
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_GET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[0])
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MESSAGE_ID_SET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr, message_id) ((opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_WORD_OFFSET (1)
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_GET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr) ((opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[1])
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MIN_LEN_SET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr, min_len) ((opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[1] = (uint16)(min_len))
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_WORD_OFFSET (2)
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_GET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr) ((opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[2])
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MAX_LEN_SET(opmsg_wwe_set_min_max_trigger_phrase_len_ptr, max_len) ((opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[2] = (uint16)(max_len))
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_CREATE(message_id, min_len, max_len) \
    (uint16)(message_id), \
    (uint16)(min_len), \
    (uint16)(max_len)
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_PACK(opmsg_wwe_set_min_max_trigger_phrase_len_ptr, message_id, min_len, max_len) \
    do { \
        (opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[1] = (uint16)((uint16)(min_len)); \
        (opmsg_wwe_set_min_max_trigger_phrase_len_ptr)->_data[2] = (uint16)((uint16)(max_len)); \
    } while (0)

#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_MARSHALL(addr, opmsg_wwe_set_min_max_trigger_phrase_len_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_set_min_max_trigger_phrase_len_ptr), 3)
#define OPMSG_WWE_SET_MIN_MAX_TRIGGER_PHRASE_LEN_UNMARSHALL(addr, opmsg_wwe_set_min_max_trigger_phrase_len_ptr) memcpy((void *)(opmsg_wwe_set_min_max_trigger_phrase_len_ptr), (void *)(addr), 3)


/*******************************************************************************

  NAME
    OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG

  DESCRIPTION
    Requests WWE to pass through audio data only after detecting the end of
    trigger phrase. This effectively strips the trigger phrase from any audio
    command that includes it.
...
/* The following macros take OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG *opmsg_wwe_strip_trigger_phrase_flag_ptr */
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_MESSAGE_ID_GET(opmsg_wwe_strip_trigger_phrase_flag_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[0])
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_MESSAGE_ID_SET(opmsg_wwe_strip_trigger_phrase_flag_ptr, message_id) ((opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_FLAG_VALUE_WORD_OFFSET (1)
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_FLAG_VALUE_GET(opmsg_wwe_strip_trigger_phrase_flag_ptr) ((opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[1])
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_FLAG_VALUE_SET(opmsg_wwe_strip_trigger_phrase_flag_ptr, flag_value) ((opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[1] = (uint16)(flag_value))
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_CREATE(message_id, flag_value) \
    (uint16)(message_id), \
    (uint16)(flag_value)
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_PACK(opmsg_wwe_strip_trigger_phrase_flag_ptr, message_id, flag_value) \
    do { \
        (opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_strip_trigger_phrase_flag_ptr)->_data[1] = (uint16)((uint16)(flag_value)); \
    } while (0)

#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_MARSHALL(addr, opmsg_wwe_strip_trigger_phrase_flag_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_strip_trigger_phrase_flag_ptr), 2)
#define OPMSG_WWE_STRIP_TRIGGER_PHRASE_FLAG_UNMARSHALL(addr, opmsg_wwe_strip_trigger_phrase_flag_ptr) memcpy((void *)(opmsg_wwe_strip_trigger_phrase_flag_ptr), (void *)(addr), 2)
...
/*******************************************************************************
  ...
  DESCRIPTION
    Requests WWE to use the listed trigger phrase files

  MEMBERS
    message_id   - message id
    num_files    - Number of files to be loaded. Currently WWE supports loading
                   only 1 file at a time
    file_id_list - List of file  IDs to be loaded. Currently WWE supports
                   loading only 1 file at a time
...
/* The following macros take OPMSG_WWE_TRIGGER_PHRASE_LOAD *opmsg_wwe_trigger_phrase_load_ptr */
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_MESSAGE_ID_GET(opmsg_wwe_trigger_phrase_load_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_trigger_phrase_load_ptr)->_data[0])
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_MESSAGE_ID_SET(opmsg_wwe_trigger_phrase_load_ptr, message_id) ((opmsg_wwe_trigger_phrase_load_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_NUM_FILES_WORD_OFFSET (1)
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_NUM_FILES_GET(opmsg_wwe_trigger_phrase_load_ptr) ((opmsg_wwe_trigger_phrase_load_ptr)->_data[1])
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_NUM_FILES_SET(opmsg_wwe_trigger_phrase_load_ptr, num_files) ((opmsg_wwe_trigger_phrase_load_ptr)->_data[1] = (uint16)(num_files))
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_FILE_ID_LIST_WORD_OFFSET (2)
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_FILE_ID_LIST_GET(opmsg_wwe_trigger_phrase_load_ptr) ((opmsg_wwe_trigger_phrase_load_ptr)->_data[2])
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_FILE_ID_LIST_SET(opmsg_wwe_trigger_phrase_load_ptr, file_id_list) ((opmsg_wwe_trigger_phrase_load_ptr)->_data[2] = (uint16)(file_id_list))
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_CREATE(message_id, num_files, file_id_list) \
    (uint16)(message_id), \
    (uint16)(num_files), \
    (uint16)(file_id_list)
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_PACK(opmsg_wwe_trigger_phrase_load_ptr, message_id, num_files, file_id_list) \
    do { \
        (opmsg_wwe_trigger_phrase_load_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_trigger_phrase_load_ptr)->_data[1] = (uint16)((uint16)(num_files)); \
        (opmsg_wwe_trigger_phrase_load_ptr)->_data[2] = (uint16)((uint16)(file_id_list)); \
    } while (0)

#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_MARSHALL(addr, opmsg_wwe_trigger_phrase_load_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_trigger_phrase_load_ptr), 3)
#define OPMSG_WWE_TRIGGER_PHRASE_LOAD_UNMARSHALL(addr, opmsg_wwe_trigger_phrase_load_ptr) memcpy((void *)(opmsg_wwe_trigger_phrase_load_ptr), (void *)(addr), 3)


/*******************************************************************************

  NAME
    OPMSG_WWE_TRIGGER_PHRASE_UNLOAD

  DESCRIPTION
    Requests WWE to unload the listed trigger phrase files

  MEMBERS
    message_id   - message id
    num_files    - Number of files to be unloaded. Currently WWE supports
                   un-loading only 1 file at a time
    file_id_list - List of file  IDs to be unloaded. Currently WWE supports
                   un-loading only 1 file at a time
...
/* The following macros take OPMSG_WWE_TRIGGER_PHRASE_UNLOAD *opmsg_wwe_trigger_phrase_unload_ptr */
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_MESSAGE_ID_GET(opmsg_wwe_trigger_phrase_unload_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_trigger_phrase_unload_ptr)->_data[0])
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_MESSAGE_ID_SET(opmsg_wwe_trigger_phrase_unload_ptr, message_id) ((opmsg_wwe_trigger_phrase_unload_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_NUM_FILES_WORD_OFFSET (1)
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_NUM_FILES_GET(opmsg_wwe_trigger_phrase_unload_ptr) ((opmsg_wwe_trigger_phrase_unload_ptr)->_data[1])
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_NUM_FILES_SET(opmsg_wwe_trigger_phrase_unload_ptr, num_files) ((opmsg_wwe_trigger_phrase_unload_ptr)->_data[1] = (uint16)(num_files))
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_FILE_ID_LIST_WORD_OFFSET (2)
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_FILE_ID_LIST_GET(opmsg_wwe_trigger_phrase_unload_ptr) ((opmsg_wwe_trigger_phrase_unload_ptr)->_data[2])
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_FILE_ID_LIST_SET(opmsg_wwe_trigger_phrase_unload_ptr, file_id_list) ((opmsg_wwe_trigger_phrase_unload_ptr)->_data[2] = (uint16)(file_id_list))
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_CREATE(message_id, num_files, file_id_list) \
    (uint16)(message_id), \
    (uint16)(num_files), \
    (uint16)(file_id_list)
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_PACK(opmsg_wwe_trigger_phrase_unload_ptr, message_id, num_files, file_id_list) \
    do { \
        (opmsg_wwe_trigger_phrase_unload_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_trigger_phrase_unload_ptr)->_data[1] = (uint16)((uint16)(num_files)); \
        (opmsg_wwe_trigger_phrase_unload_ptr)->_data[2] = (uint16)((uint16)(file_id_list)); \
    } while (0)

#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_MARSHALL(addr, opmsg_wwe_trigger_phrase_unload_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_trigger_phrase_unload_ptr), 3)
#define OPMSG_WWE_TRIGGER_PHRASE_UNLOAD_UNMARSHALL(addr, opmsg_wwe_trigger_phrase_unload_ptr) memcpy((void *)(opmsg_wwe_trigger_phrase_unload_ptr), (void *)(addr), 3)
...
/*******************************************************************************
  ...
  NAME
    Opmsg_Ksp_Set_Stream_Timing_Trace

  DESCRIPTION
    KSP operator message for SET_STREAM_TIMING_TRACE mesage ID.

  MEMBERS
    message_id        - message id
    stream_id         - Stream ID, operators can potentially support up to 4
                        concurrent streams, numbered 0 thru 3. Only one Timing
                        Trace stream can be configured at a time.
    nr_samples        - Number of samples/channel that are read and packetised
                        by the operator. If set to 0 operator will choose a
                        suitable number. Maximum 256 samples.
    setup_buffer_size - Set the size of the buffer for setup (operator creation
                        and connection) records. If zero, a small default value
                        will be used.
    event_buffer_size - Set the size of the buffer for event records. If zero, a
                        small default value will be used.
    enable_mask       - This field is a bitmask enabling subsets of traceable
                        information. Bit 0: 1 to enable recording transform
                        buffer levels Bit 1: 1 to enable recording all
                        transforms, ignoring the transform_mask_N fields.
    transform_mask_0  - Word 0 of array of 16 words times 16 bits forming a 256
                        bit mask. The words are indexed by bit 4-7 of 8 bit
                        internal transform ID, the bits in each word are indexed
                        by bit 0-3 of the internal transform ID. A bit value 1
                        enables recording buffer levels for the indexed
                        transform. Internal transform IDs are external transform
                        IDs xor 0x1c1e. Bit 0 of transform_mask_0 does not
                        represent a valid transform ID.
    transform_mask_1  - Word 1 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_2  - Word 2 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_3  - Word 3 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_4  - Word 4 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_5  - Word 5 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_6  - Word 6 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_7  - Word 7 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_8  - Word 8 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_9  - Word 9 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_10 - Word 10 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_11 - Word 11 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_12 - Word 12 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_13 - Word 13 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_14 - Word 14 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
    transform_mask_15 - Word 15 of array of 16 words times 16 bits forming a 256
                        bit mask. See description of transform_mask_0.
...
/* The following macros take OPMSG_KSP_SET_STREAM_TIMING_TRACE *opmsg_ksp_set_stream_timing_trace_ptr */
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_MESSAGE_ID_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((OPMSG_KSP_ID)(opmsg_ksp_set_stream_timing_trace_ptr)->_data[0])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_MESSAGE_ID_SET(opmsg_ksp_set_stream_timing_trace_ptr, message_id) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_STREAM_ID_WORD_OFFSET (1)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_STREAM_ID_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[1])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_STREAM_ID_SET(opmsg_ksp_set_stream_timing_trace_ptr, stream_id) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[1] = (uint16)(stream_id))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_NR_SAMPLES_WORD_OFFSET (2)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_NR_SAMPLES_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[2])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_NR_SAMPLES_SET(opmsg_ksp_set_stream_timing_trace_ptr, nr_samples) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[2] = (uint16)(nr_samples))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_SETUP_BUFFER_SIZE_WORD_OFFSET (3)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_SETUP_BUFFER_SIZE_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[3])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_SETUP_BUFFER_SIZE_SET(opmsg_ksp_set_stream_timing_trace_ptr, setup_buffer_size) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[3] = (uint16)(setup_buffer_size))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_EVENT_BUFFER_SIZE_WORD_OFFSET (4)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_EVENT_BUFFER_SIZE_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[4])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_EVENT_BUFFER_SIZE_SET(opmsg_ksp_set_stream_timing_trace_ptr, event_buffer_size) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[4] = (uint16)(event_buffer_size))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_ENABLE_MASK_WORD_OFFSET (5)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_ENABLE_MASK_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[5])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_ENABLE_MASK_SET(opmsg_ksp_set_stream_timing_trace_ptr, enable_mask) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[5] = (uint16)(enable_mask))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_0_WORD_OFFSET (6)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_0_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[6])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_0_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_0) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[6] = (uint16)(transform_mask_0))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_1_WORD_OFFSET (7)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_1_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[7])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_1_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_1) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[7] = (uint16)(transform_mask_1))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_2_WORD_OFFSET (8)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_2_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[8])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_2_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_2) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[8] = (uint16)(transform_mask_2))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_3_WORD_OFFSET (9)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_3_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[9])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_3_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_3) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[9] = (uint16)(transform_mask_3))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_4_WORD_OFFSET (10)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_4_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[10])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_4_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_4) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[10] = (uint16)(transform_mask_4))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_5_WORD_OFFSET (11)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_5_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[11])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_5_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_5) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[11] = (uint16)(transform_mask_5))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_6_WORD_OFFSET (12)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_6_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[12])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_6_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_6) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[12] = (uint16)(transform_mask_6))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_7_WORD_OFFSET (13)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_7_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[13])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_7_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_7) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[13] = (uint16)(transform_mask_7))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_8_WORD_OFFSET (14)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_8_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[14])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_8_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_8) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[14] = (uint16)(transform_mask_8))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_9_WORD_OFFSET (15)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_9_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[15])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_9_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_9) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[15] = (uint16)(transform_mask_9))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_10_WORD_OFFSET (16)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_10_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[16])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_10_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_10) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[16] = (uint16)(transform_mask_10))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_11_WORD_OFFSET (17)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_11_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[17])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_11_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_11) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[17] = (uint16)(transform_mask_11))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_12_WORD_OFFSET (18)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_12_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[18])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_12_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_12) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[18] = (uint16)(transform_mask_12))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_13_WORD_OFFSET (19)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_13_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[19])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_13_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_13) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[19] = (uint16)(transform_mask_13))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_14_WORD_OFFSET (20)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_14_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[20])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_14_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_14) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[20] = (uint16)(transform_mask_14))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_15_WORD_OFFSET (21)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_15_GET(opmsg_ksp_set_stream_timing_trace_ptr) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[21])
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_TRANSFORM_MASK_15_SET(opmsg_ksp_set_stream_timing_trace_ptr, transform_mask_15) ((opmsg_ksp_set_stream_timing_trace_ptr)->_data[21] = (uint16)(transform_mask_15))
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_WORD_SIZE (22)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_CREATE(message_id, stream_id, nr_samples, setup_buffer_size, event_buffer_size, enable_mask, transform_mask_0, transform_mask_1, transform_mask_2, transform_mask_3, transform_mask_4, transform_mask_5, transform_mask_6, transform_mask_7, transform_mask_8, transform_mask_9, transform_mask_10, transform_mask_11, transform_mask_12, transform_mask_13, transform_mask_14, transform_mask_15) \
    (uint16)(message_id), \
    (uint16)(stream_id), \
    (uint16)(nr_samples), \
    (uint16)(setup_buffer_size), \
    (uint16)(event_buffer_size), \
    (uint16)(enable_mask), \
    (uint16)(transform_mask_0), \
    (uint16)(transform_mask_1), \
    (uint16)(transform_mask_2), \
    (uint16)(transform_mask_3), \
    (uint16)(transform_mask_4), \
    (uint16)(transform_mask_5), \
    (uint16)(transform_mask_6), \
    (uint16)(transform_mask_7), \
    (uint16)(transform_mask_8), \
    (uint16)(transform_mask_9), \
    (uint16)(transform_mask_10), \
    (uint16)(transform_mask_11), \
    (uint16)(transform_mask_12), \
    (uint16)(transform_mask_13), \
    (uint16)(transform_mask_14), \
    (uint16)(transform_mask_15)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_PACK(opmsg_ksp_set_stream_timing_trace_ptr, message_id, stream_id, nr_samples, setup_buffer_size, event_buffer_size, enable_mask, transform_mask_0, transform_mask_1, transform_mask_2, transform_mask_3, transform_mask_4, transform_mask_5, transform_mask_6, transform_mask_7, transform_mask_8, transform_mask_9, transform_mask_10, transform_mask_11, transform_mask_12, transform_mask_13, transform_mask_14, transform_mask_15) \
    do { \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[1] = (uint16)((uint16)(stream_id)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[2] = (uint16)((uint16)(nr_samples)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[3] = (uint16)((uint16)(setup_buffer_size)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[4] = (uint16)((uint16)(event_buffer_size)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[5] = (uint16)((uint16)(enable_mask)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[6] = (uint16)((uint16)(transform_mask_0)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[7] = (uint16)((uint16)(transform_mask_1)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[8] = (uint16)((uint16)(transform_mask_2)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[9] = (uint16)((uint16)(transform_mask_3)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[10] = (uint16)((uint16)(transform_mask_4)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[11] = (uint16)((uint16)(transform_mask_5)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[12] = (uint16)((uint16)(transform_mask_6)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[13] = (uint16)((uint16)(transform_mask_7)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[14] = (uint16)((uint16)(transform_mask_8)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[15] = (uint16)((uint16)(transform_mask_9)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[16] = (uint16)((uint16)(transform_mask_10)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[17] = (uint16)((uint16)(transform_mask_11)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[18] = (uint16)((uint16)(transform_mask_12)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[19] = (uint16)((uint16)(transform_mask_13)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[20] = (uint16)((uint16)(transform_mask_14)); \
        (opmsg_ksp_set_stream_timing_trace_ptr)->_data[21] = (uint16)((uint16)(transform_mask_15)); \
    } while (0)

#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_MARSHALL(addr, opmsg_ksp_set_stream_timing_trace_ptr) memcpy((void *)(addr), (void *)(opmsg_ksp_set_stream_timing_trace_ptr), 22)
#define OPMSG_KSP_SET_STREAM_TIMING_TRACE_UNMARSHALL(addr, opmsg_ksp_set_stream_timing_trace_ptr) memcpy((void *)(opmsg_ksp_set_stream_timing_trace_ptr), (void *)(addr), 22)
...
/*******************************************************************************
  ...
  DESCRIPTION
    Send this message to set the time that an auxiliary input shall be
    played. The message will be valid for only one auxiliary burst. If the
    time to play isn't set the auxiliary burst will be played in normal
    non-timed playback mode, which means it will be mixed and played as it is
    received.

  MEMBERS
    message_id        - message id
    aux_channel_index - Index of the aux channel that this message is for. This
                        feature is supported only on first auxiliary channel, so
                        it needs to be 0.
    aux_time_to_play  - The absolute local timer time at which the first sample
                        of auxiliary input shall be played at the output
                        interface. It needs to be sufficiently in the future so
                        the operator can meet the requested time to play
                        deadline.
    aux_drift_rate    - A rate that shall be applied to auxiliary input for fine
                        adjustment, in 1/10 of ppm. This is to make sure very
                        long aux prompts will stay synchronised when devices
                        have significant clock mismatch. Drift rate field is
                        signed, a positive value means the local device is
                        faster i.e. should consume auxiliary samples slower;
                        similarly a negative value means device shall consume
                        auxiliary samples faster. Note: This is not effective
                        yet and is for future improvement only.
...
/* The following macros take OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY *opmsg_vol_ctrl_set_aux_time_to_play_ptr */
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_MESSAGE_ID_GET(opmsg_vol_ctrl_set_aux_time_to_play_ptr) ((OPMSG_VOL_CTRL_ID)(opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[0])
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_MESSAGE_ID_SET(opmsg_vol_ctrl_set_aux_time_to_play_ptr, message_id) ((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_CHANNEL_INDEX_WORD_OFFSET (1)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_CHANNEL_INDEX_GET(opmsg_vol_ctrl_set_aux_time_to_play_ptr) ((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[1])
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_CHANNEL_INDEX_SET(opmsg_vol_ctrl_set_aux_time_to_play_ptr, aux_channel_index) ((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[1] = (uint16)(aux_channel_index))
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_TIME_TO_PLAY_WORD_OFFSET (2)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_TIME_TO_PLAY_GET(opmsg_vol_ctrl_set_aux_time_to_play_ptr)  \
    (((uint32)((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[2]) | \
      ((uint32)((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[3]) << 16)))
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_TIME_TO_PLAY_SET(opmsg_vol_ctrl_set_aux_time_to_play_ptr, aux_time_to_play) do { \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[2] = (uint16)((aux_time_to_play) & 0xffff); \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[3] = (uint16)((aux_time_to_play) >> 16); } while (0)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_DRIFT_RATE_WORD_OFFSET (4)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_DRIFT_RATE_GET(opmsg_vol_ctrl_set_aux_time_to_play_ptr) ((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[4])
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_AUX_DRIFT_RATE_SET(opmsg_vol_ctrl_set_aux_time_to_play_ptr, aux_drift_rate) ((opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[4] = (uint16)(aux_drift_rate))
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_WORD_SIZE (5)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_CREATE(message_id, aux_channel_index, aux_time_to_play, aux_drift_rate) \
    (uint16)(message_id), \
    (uint16)(aux_channel_index), \
    (uint16)((aux_time_to_play) & 0xffff), \
    (uint16)((aux_time_to_play) >> 16), \
    (uint16)(aux_drift_rate)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_PACK(opmsg_vol_ctrl_set_aux_time_to_play_ptr, message_id, aux_channel_index, aux_time_to_play, aux_drift_rate) \
    do { \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[1] = (uint16)((uint16)(aux_channel_index)); \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[2] = (uint16)((uint16)((aux_time_to_play) & 0xffff)); \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[3] = (uint16)(((aux_time_to_play) >> 16)); \
        (opmsg_vol_ctrl_set_aux_time_to_play_ptr)->_data[4] = (uint16)((uint16)(aux_drift_rate)); \
    } while (0)

#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_MARSHALL(addr, opmsg_vol_ctrl_set_aux_time_to_play_ptr) memcpy((void *)(addr), (void *)(opmsg_vol_ctrl_set_aux_time_to_play_ptr), 5)
#define OPMSG_VOL_CTRL_SET_AUX_TIME_TO_PLAY_UNMARSHALL(addr, opmsg_vol_ctrl_set_aux_time_to_play_ptr) memcpy((void *)(opmsg_vol_ctrl_set_aux_time_to_play_ptr), (void *)(addr), 5)
...
/*******************************************************************************
  ...
  DESCRIPTION
    Send this message to set an estimation of the maximum downstream latency
    after the operator; This value is only used for timed playback of
    auxiliary input and has no other use. By default the operator works out a
    value for downstream latency which will be good enough if there aren't
    any non-in-place operator down the chain. Underestimation of the latency
    could cause cutting of the start of tone/prompts while an overestimation
    could cause missing deadline for timed playback of prompts. A good
    estimation would be 75% of total length(in ms) of downstream buffers plus
    one system kick period.

  MEMBERS
    message_id     - message id
    latency_est_ms - Downstream latency estimate in ms; Maximum 200ms, operator
                     message will fail if a value bigger than 200ms is sent.
...
/* The following macros take OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST *opmsg_vol_ctrl_set_downstream_latency_est_ptr */
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_MESSAGE_ID_GET(opmsg_vol_ctrl_set_downstream_latency_est_ptr) ((OPMSG_VOL_CTRL_ID)(opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[0])
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_MESSAGE_ID_SET(opmsg_vol_ctrl_set_downstream_latency_est_ptr, message_id) ((opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_LATENCY_EST_MS_WORD_OFFSET (1)
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_LATENCY_EST_MS_GET(opmsg_vol_ctrl_set_downstream_latency_est_ptr) ((opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[1])
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_LATENCY_EST_MS_SET(opmsg_vol_ctrl_set_downstream_latency_est_ptr, latency_est_ms) ((opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[1] = (uint16)(latency_est_ms))
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_CREATE(message_id, latency_est_ms) \
    (uint16)(message_id), \
    (uint16)(latency_est_ms)
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_PACK(opmsg_vol_ctrl_set_downstream_latency_est_ptr, message_id, latency_est_ms) \
    do { \
        (opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_vol_ctrl_set_downstream_latency_est_ptr)->_data[1] = (uint16)((uint16)(latency_est_ms)); \
    } while (0)

#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_MARSHALL(addr, opmsg_vol_ctrl_set_downstream_latency_est_ptr) memcpy((void *)(addr), (void *)(opmsg_vol_ctrl_set_downstream_latency_est_ptr), 2)
#define OPMSG_VOL_CTRL_SET_DOWNSTREAM_LATENCY_EST_UNMARSHALL(addr, opmsg_vol_ctrl_set_downstream_latency_est_ptr) memcpy((void *)(opmsg_vol_ctrl_set_downstream_latency_est_ptr), (void *)(addr), 2)


/*******************************************************************************

  NAME
    Opmsg_WWE_Reset_Status

  DESCRIPTION
    Reset the WWE status
...
/* The following macros take OPMSG_WWE_RESET_STATUS *opmsg_wwe_reset_status_ptr */
#define OPMSG_WWE_RESET_STATUS_MESSAGE_ID_WORD_OFFSET (0)
#define OPMSG_WWE_RESET_STATUS_MESSAGE_ID_GET(opmsg_wwe_reset_status_ptr) ((OPMSG_WWE_ID)(opmsg_wwe_reset_status_ptr)->_data[0])
#define OPMSG_WWE_RESET_STATUS_MESSAGE_ID_SET(opmsg_wwe_reset_status_ptr, message_id) ((opmsg_wwe_reset_status_ptr)->_data[0] = (uint16)(message_id))
#define OPMSG_WWE_RESET_STATUS_WWE_RESET_STATUS_WORD_OFFSET (1)
#define OPMSG_WWE_RESET_STATUS_WWE_RESET_STATUS_GET(opmsg_wwe_reset_status_ptr) ((opmsg_wwe_reset_status_ptr)->_data[1])
#define OPMSG_WWE_RESET_STATUS_WWE_RESET_STATUS_SET(opmsg_wwe_reset_status_ptr, wwe_reset_status) ((opmsg_wwe_reset_status_ptr)->_data[1] = (uint16)(wwe_reset_status))
#define OPMSG_WWE_RESET_STATUS_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_RESET_STATUS_CREATE(message_id, wwe_reset_status) \
    (uint16)(message_id), \
    (uint16)(wwe_reset_status)
#define OPMSG_WWE_RESET_STATUS_PACK(opmsg_wwe_reset_status_ptr, message_id, wwe_reset_status) \
    do { \
        (opmsg_wwe_reset_status_ptr)->_data[0] = (uint16)((uint16)(message_id)); \
        (opmsg_wwe_reset_status_ptr)->_data[1] = (uint16)((uint16)(wwe_reset_status)); \
    } while (0)

#define OPMSG_WWE_RESET_STATUS_MARSHALL(addr, opmsg_wwe_reset_status_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_reset_status_ptr), 2)
#define OPMSG_WWE_RESET_STATUS_UNMARSHALL(addr, opmsg_wwe_reset_status_ptr) memcpy((void *)(opmsg_wwe_reset_status_ptr), (void *)(addr), 2)
...
/* The following macros take OPMSG_WWE_TRIGGER_CHANNEL_INFO *opmsg_wwe_trigger_channel_info_ptr */
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_TRIGGER_CONFIDENCE_WORD_OFFSET (0)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_TRIGGER_CONFIDENCE_GET(opmsg_wwe_trigger_channel_info_ptr) ((opmsg_wwe_trigger_channel_info_ptr)->_data[0])
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_TRIGGER_CONFIDENCE_SET(opmsg_wwe_trigger_channel_info_ptr, trigger_confidence) ((opmsg_wwe_trigger_channel_info_ptr)->_data[0] = (uint16)(trigger_confidence))
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_UPPER_WORD_OFFSET (1)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_UPPER_GET(opmsg_wwe_trigger_channel_info_ptr) ((opmsg_wwe_trigger_channel_info_ptr)->_data[1])
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_UPPER_SET(opmsg_wwe_trigger_channel_info_ptr, start_timestamp_upper) ((opmsg_wwe_trigger_channel_info_ptr)->_data[1] = (uint16)(start_timestamp_upper))
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_LOWER_WORD_OFFSET (2)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_LOWER_GET(opmsg_wwe_trigger_channel_info_ptr) ((opmsg_wwe_trigger_channel_info_ptr)->_data[2])
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_START_TIMESTAMP_LOWER_SET(opmsg_wwe_trigger_channel_info_ptr, start_timestamp_lower) ((opmsg_wwe_trigger_channel_info_ptr)->_data[2] = (uint16)(start_timestamp_lower))
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_UPPER_WORD_OFFSET (3)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_UPPER_GET(opmsg_wwe_trigger_channel_info_ptr) ((opmsg_wwe_trigger_channel_info_ptr)->_data[3])
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_UPPER_SET(opmsg_wwe_trigger_channel_info_ptr, end_timestamp_upper) ((opmsg_wwe_trigger_channel_info_ptr)->_data[3] = (uint16)(end_timestamp_upper))
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_LOWER_WORD_OFFSET (4)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_LOWER_GET(opmsg_wwe_trigger_channel_info_ptr) ((opmsg_wwe_trigger_channel_info_ptr)->_data[4])
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_END_TIMESTAMP_LOWER_SET(opmsg_wwe_trigger_channel_info_ptr, end_timestamp_lower) ((opmsg_wwe_trigger_channel_info_ptr)->_data[4] = (uint16)(end_timestamp_lower))
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_WORD_SIZE (5)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_CREATE(trigger_confidence, start_timestamp_upper, start_timestamp_lower, end_timestamp_upper, end_timestamp_lower) \
    (uint16)(trigger_confidence), \
    (uint16)(start_timestamp_upper), \
    (uint16)(start_timestamp_lower), \
    (uint16)(end_timestamp_upper), \
    (uint16)(end_timestamp_lower)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_PACK(opmsg_wwe_trigger_channel_info_ptr, trigger_confidence, start_timestamp_upper, start_timestamp_lower, end_timestamp_upper, end_timestamp_lower) \
    do { \
        (opmsg_wwe_trigger_channel_info_ptr)->_data[0] = (uint16)((uint16)(trigger_confidence)); \
        (opmsg_wwe_trigger_channel_info_ptr)->_data[1] = (uint16)((uint16)(start_timestamp_upper)); \
        (opmsg_wwe_trigger_channel_info_ptr)->_data[2] = (uint16)((uint16)(start_timestamp_lower)); \
        (opmsg_wwe_trigger_channel_info_ptr)->_data[3] = (uint16)((uint16)(end_timestamp_upper)); \
        (opmsg_wwe_trigger_channel_info_ptr)->_data[4] = (uint16)((uint16)(end_timestamp_lower)); \
    } while (0)

#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_MARSHALL(addr, opmsg_wwe_trigger_channel_info_ptr) memcpy((void *)(addr), (void *)(opmsg_wwe_trigger_channel_info_ptr), 5)
#define OPMSG_WWE_TRIGGER_CHANNEL_INFO_UNMARSHALL(addr, opmsg_wwe_trigger_channel_info_ptr) memcpy((void *)(opmsg_wwe_trigger_channel_info_ptr), (void *)(addr), 5)
...
/* The following macros take OPMSG_UNSOLICITED_WWE_TRIGGER *opmsg_unsolicited_wwe_trigger_ptr */
#define OPMSG_UNSOLICITED_WWE_TRIGGER_NUMBER_OF_CHANNELS_WORD_OFFSET (0)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_NUMBER_OF_CHANNELS_GET(opmsg_unsolicited_wwe_trigger_ptr) ((opmsg_unsolicited_wwe_trigger_ptr)->_data[0])
#define OPMSG_UNSOLICITED_WWE_TRIGGER_NUMBER_OF_CHANNELS_SET(opmsg_unsolicited_wwe_trigger_ptr, number_of_channels) ((opmsg_unsolicited_wwe_trigger_ptr)->_data[0] = (uint16)(number_of_channels))
#define OPMSG_UNSOLICITED_WWE_TRIGGER_CH0_TRIGGER_DETAILS_WORD_OFFSET (1)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_CH1_TRIGGER_DETAILS_WORD_OFFSET (6)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_CH2_TRIGGER_DETAILS_WORD_OFFSET (11)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_CH3_TRIGGER_DETAILS_WORD_OFFSET (16)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_WORD_SIZE (21)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_UNSOLICITED_WWE_TRIGGER_CREATE(number_of_channels) \
    (uint16)(number_of_channels)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_PACK(opmsg_unsolicited_wwe_trigger_ptr, number_of_channels) \
    do { \
        (opmsg_unsolicited_wwe_trigger_ptr)->_data[0] = (uint16)((uint16)(number_of_channels)); \
    } while (0)

#define OPMSG_UNSOLICITED_WWE_TRIGGER_MARSHALL(addr, opmsg_unsolicited_wwe_trigger_ptr) memcpy((void *)(addr), (void *)(opmsg_unsolicited_wwe_trigger_ptr), 21)
#define OPMSG_UNSOLICITED_WWE_TRIGGER_UNMARSHALL(addr, opmsg_unsolicited_wwe_trigger_ptr) memcpy((void *)(opmsg_unsolicited_wwe_trigger_ptr), (void *)(addr), 21)
