...
/*******************************************************************************
 ...
 VALUES
    ...
    OPUS_CELT_ENCODE
                   - Opus-CELT encoder
    GVA
                   - Google Voice Assistant, Google's phrase recognition engine
    APVA
                   - Amazon Pryon Voice Assistant, Amazon's phrase recognition
                     engine
    CVC_FBC
                   - cVc Fullband echo canceller
    TEST_VA
    ...
    DOWNLOAD_GOOGLE_VOICE_ASSISTANT
                   - Downloadable Google Voice Assistant, Google's phrase
                     recognition engine
    DOWNLOAD_AMAZON_VOICE_ASSISTANT
                   - Downloadable Amazon Pryon Voice Assistant, Amazon's phrase
                     recognition engine
    DOWNLOAD_CVC_FBC
                   - cVc Full-band echo canceller
    DUMMY_ID_FORCE_INT
...
typedef enum
{
    ...
    CAP_ID_DOWNLOAD_GOOGLE_VOICE_ASSISTANT = 0x409B,
    CAP_ID_DOWNLOAD_AMAZON_VOICE_ASSISTANT = 0x409C,
    CAP_ID_DOWNLOAD_CVC_FBC = 0x409e,
