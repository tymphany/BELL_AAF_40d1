...
static bool appPioInit(Task init_task)
{
    ...
    /* Make LDO3V output high for now*/
    PioSetMapPins32Bank(0, 1UL << RDP_PIO_LDO3V, 1UL << RDP_PIO_LDO3V);
    PioSetDir32Bank(0, 1UL << RDP_PIO_LDO3V, 1UL << RDP_PIO_LDO3V);
    PioSet32Bank(0, 1UL << RDP_PIO_LDO3V, 1UL << RDP_PIO_LDO3V);
