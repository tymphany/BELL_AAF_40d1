...
{
    AMA_INFO(("amaRfcomm_LinkCreatedCfm status=%d server_channel=%d payload_size=%d  sink=%p\n", cfm->status, cfm->server_channel, cfm->payload_size, (void *) cfm-> sink));
...
{
    AMA_INFO(("AMA_RFCOMM_LINK_DISCONNECTED_CFM\n"));
...
static void amaRfcomm_MessageHandler(Task task, MessageId id, Message message)
{
    ...
    AMA_INFO(("amaRfcomm_MessageHandler id %x \n", id));

    switch (id)
    {
        case CL_RFCOMM_REGISTER_CFM:
        {
            AMA_INFO(("AMA_RFCOMM CL_RFCOMM_REGISTER_CFM\n"));
        ...
        case CL_SDP_REGISTER_CFM:
            AMA_INFO(("AMA_RFCOMM CL_SDP_REGISTER_CFM \n"));
            break;

        case CL_RFCOMM_CONNECT_IND:
        {
            AMA_INFO(("AMA_RFCOMM CL_RFCOMM_CONNECT_IND connections_allowed %d\n", ama_rfcomm_data.connections_allowed));
        ...
        {
            AMA_INFO(("AMA_RFCOMM CL_RFCOMM_DISCONNECT_CFM\n"));
        ...
        {
            AMA_INFO(("AMA_RFCOMM CL_RFCOMM_PORTNEG_IND\n"));
        ...
        {
            AMA_INFO(("AMA_RFCOMM RFCOMM MESSAGE_MORE_DATA\n"));
        ...
        {
            AMA_INFO(("AMA_RFCOMM AMA_RFCOMM_LOCAL_DISCONNECT_REQ_IND\n"));
        ...
        {
            AMA_INFO(("AMA_RFCOMM AMA_RFCOMM_LOCAL_ALLOW_CONNECTIONS_IND\n"));
        ...
        case PHY_STATE_CHANGED_IND:
        {
            ...
            AMA_INFO(("AMA_RFCOMM RFCOMM PHY_STATE_CHANGED_IND state=%u\n", msg->new_state));
        ...
        default:
            AMA_INFO(("AMA_RFCOMM rfCommMessageHandler unknown message=%x\n", id));
            break;
 ...
 bool AmaRfcomm_SendData(uint8* data, uint16 length)
{
    ...
    if( ama_rfcomm_data.data_sink)
    {
        ...
        AMA_INFO(("amaRfcomm_SendData RS %d\n",SinkSlack(sink)));
