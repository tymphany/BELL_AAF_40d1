...
#define DEBUG_AMA_LOG

#define DEBUG_LOG_AMA_NAME          "AMA"
#ifdef DEBUG_AMA_LOG
#define DEBUG_AMA(x)                DEBUG_LOG x
#define AMA_WARNING(x)              DEBUG_LOG(DEBUG_LOG_AMA_NAME ":WARNING: " x)
#else
#define DEBUG_AMA(x)
#define AMA_WARNING(x)
#endif
#define AMA_INFO(x)                 DEBUG_AMA(x)
