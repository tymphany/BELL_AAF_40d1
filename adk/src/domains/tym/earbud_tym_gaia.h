...
typedef enum {
    ...
    BELL_GAIA_SET_FINDME_COMMAND = 0x0032,
    BELL_GAIA_GET_PROMPT_LANG_COMMAND = 0x0034,
    BELL_GAIA_GET_WEAE_DETECT_COMMAND = 0x0035, 
    BELL_GAIA_SET_WEAR_DETECT_COMMAND = 0x0036,   
    BELL_GAIA_NO_OPERATION_COMMAND = 0x0100,
    BELL_GAIA_SER_AUDIO_CONTROL_COMMAND = 0x0200,
    BELL_GAIA_SET_EQ_CONTROL_COMMAND = 0x0201,
    BELL_GAIA_GET_EQ_CONTROL_COMMAND = 0x0202,
...
typedef enum {
    BELL_GAIA_AUDIO_CONTROL_VOL_UP = 0x01,
    BELL_GAIA_AUDIO_CONTROL_VOL_DOWN,
    BELL_GAIA_AUDIO_CONTROL_PLAY,
    BELL_GAIA_AUDIO_CONTROL_PAUSE,
    BELL_GAIA_AUDIO_CONTROL_Stop,
    BELL_GAIA_AUDIO_CONTROL_MIC_MUTE,
    BELL_GAIA_AUDIO_CONTROL_MIC_UNMUTE,
    BELL_GAIA_AUDIO_CONTROL_SKIP_FORWARD,
    BELL_GAIA_AUDIO_CONTROL_BACK_FORWARD,
}BELL_GAIA_AUDIO_CONTROL_E;
