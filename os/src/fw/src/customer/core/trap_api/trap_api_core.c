...
static uint16 read_security_request(uint16 read)
{
    ...
    ipc_send(IPC_SIGNAL_ID_VM_READ_SECURITY, &ipc_send_prim, sizeof(ipc_send_prim));
    (void)ipc_recv(IPC_SIGNAL_ID_VM_READ_SECURITY_RSP, &ipc_recv_prim);
...
static bool enable_security_request(uint16 enable)
{
    ...
    ipc_send(IPC_SIGNAL_ID_VM_ENABLE_SECURITY, &ipc_send_prim, sizeof(ipc_send_prim));
    (void)ipc_recv(IPC_SIGNAL_ID_VM_ENABLE_SECURITY_RSP, &ipc_recv_prim);
