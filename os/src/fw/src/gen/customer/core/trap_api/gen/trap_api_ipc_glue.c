...
#include "trap_api/chargercomms.h" 
...
{
    IPC_DEBUG_PARTITION_CONFIG ipc_send_prim;
    IPC_DEBUG_PARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.key = key;
    ipc_send_prim.value = value;
    ipc_send(IPC_SIGNAL_ID_DEBUG_PARTITION_CONFIG, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_DEBUG_PARTITION_CONFIG_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_DEBUG_PARTITION_INFO ipc_send_prim;
    IPC_DEBUG_PARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send_prim.key = key;
    ipc_send_prim.value = value;
    ipc_send(IPC_SIGNAL_ID_DEBUG_PARTITION_INFO, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_DEBUG_PARTITION_INFO_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_DEBUG_PARTITION_ERASE ipc_send_prim;
    IPC_DEBUG_PARTITION_RESULT_RSP ipc_recv_prim;
    ipc_send(IPC_SIGNAL_ID_DEBUG_PARTITION_ERASE, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_DEBUG_PARTITION_ERASE_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_STREAM_DEBUG_PARTITION_SOURCE ipc_send_prim;
    IPC_SOURCE_RSP ipc_recv_prim;
    ipc_send(IPC_SIGNAL_ID_STREAM_DEBUG_PARTITION_SOURCE, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_STREAM_DEBUG_PARTITION_SOURCE_RSP, &ipc_recv_prim);
    return SOURCE_FROM_ID(ipc_recv_prim.ret);
}
...
{
    IPC_QSPI_IDENTITY_REQUEST ipc_send_prim;
    IPC_VOID_RSP ipc_recv_prim;
    ipc_send_prim.jedec_id = jedec_id;
    ipc_send_prim.device_id = device_id;
    ipc_send(IPC_SIGNAL_ID_QSPI_IDENTITY_REQUEST, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_QSPI_IDENTITY_REQUEST_RSP, &ipc_recv_prim);
}


bool QspiUIDRequest(flash_ops_uid_read_method uid_method, uint8 * uid)
{
    IPC_QSPI_U_I_D_REQUEST ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.uid_method = uid_method;
    ipc_send_prim.uid = uid;
    ipc_send(IPC_SIGNAL_ID_QSPI_U_I_D_REQUEST, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_QSPI_U_I_D_REQUEST_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_QSPI_O_T_P_REQUEST ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.otp_method = otp_method;
    ipc_send_prim.otp_address = otp_address;
    ipc_send_prim.otp_length = otp_length;
    ipc_send_prim.otp = otp;
    ipc_send(IPC_SIGNAL_ID_QSPI_O_T_P_REQUEST, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_QSPI_O_T_P_REQUEST_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_VM_ADVERTISE_POWER_SET_MAXIMUM ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.override = override;
    ipc_send_prim.power = power;
    ipc_send(IPC_SIGNAL_ID_VM_ADVERTISE_POWER_SET_MAXIMUM, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_VM_ADVERTISE_POWER_SET_MAXIMUM_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
...
{
    IPC_CHARGER_COMMS_TRANSMIT ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.length = length;
    ipc_send_prim.data = data;
    ipc_send(IPC_SIGNAL_ID_CHARGER_COMMS_TRANSMIT, &ipc_send_prim, sizeof(ipc_send_prim));
    assert(!ipc_disallow_high_priority_handler_calls());
    (void)ipc_recv(IPC_SIGNAL_ID_CHARGER_COMMS_TRANSMIT_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
